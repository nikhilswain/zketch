...
export const VaultModel = types
  ...
  .views((self) => ({
    get sortedDrawings() {
      return [...self.drawings].sort((a, b) => b.updatedAt.getTime() - a.updatedAt.getTime())
    },
    get isEmpty() {
  ...
  .actions((self) => ({
    ...
    replaceDrawingStrokes(id: string, strokes: SnapshotIn<typeof Stroke>[], thumbnail: string, background: string) {
      const drawing = self.drawings.find((d) => d.id === id)
      if (drawing) {
  ...
  .actions((self) => ({
    ...
    async addDrawing(name: string, strokes: SnapshotIn<typeof Stroke>[], thumbnail: string, background: string) {
      const drawingData = {
    ...
    async updateDrawing(id: string, strokes: SnapshotIn<typeof Stroke>[], thumbnail: string, background: string) {

...
export const useKeyboardShortcuts = (
  ...
  useEffect(() => {
    ...
    // Tool selection
    KeyBindingManager.registerHandler("selectPen", () => canvasStore.setBrushStyle("ink"))
    KeyBindingManager.registerHandler("selectMarker", () => canvasStore.setBrushStyle("marker"))
    KeyBindingManager.registerHandler("selectBrush", () => canvasStore.setBrushStyle("brush"))
    KeyBindingManager.registerHandler("selectCalligraphy", () => canvasStore.setBrushStyle("calligraphy"))
    KeyBindingManager.registerHandler("selectPencil", () => canvasStore.setBrushStyle("pencil"))
    ...
    // UI controls
    KeyBindingManager.registerHandler("toggleSidebar", () => onToggleSidebar?.())
    KeyBindingManager.registerHandler("toggleVault", () => onToggleVault?.())

    // Color shortcuts
    KeyBindingManager.registerHandler("selectBlack", () => canvasStore.setColor("#000000"))
    KeyBindingManager.registerHandler("selectWhite", () => canvasStore.setColor("#ffffff"))
    KeyBindingManager.registerHandler("selectRed", () => canvasStore.setColor("#ef4444"))
